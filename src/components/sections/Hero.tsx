...
export function Hero() {
  return (
    <section id="top" className="relative min-h-screen flex items-center bg-charcoal text-charcoal-foreground overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-charcoal/95 via-charcoal/75 to-charcoal" />

      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 pt-32 pb-20 md:py-32 w-full text-center md:text-left">
        <div className="flex justify-center md:justify-start mb-10 md:mb-14">
          <Logo className="h-24 sm:h-32 md:h-40 lg:h-48 w-auto" />
        </div>

        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.05] max-w-5xl mx-auto md:mx-0 font-medium tracking-tight">
          Building the Operating System for New Home Sales.
        </h1>
        <p className="mt-8 max-w-2xl mx-auto md:mx-0 text-base md:text-lg text-charcoal-foreground/75 leading-relaxed">
